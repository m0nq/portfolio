...
const Contact: React.FC<PageProps> = () => {
    ...
    return (
        <>
            <form method="POST" action="https://formspree.io/f/xdoqjkon" id="contact-form" onSubmit={handleSubmit}>
                <fieldset id="contact-form-group" className="contact-form">
                    <label htmlFor="full-name">Name</label>
                    <input type="text" name="name" id="full-name" placeholder="First and Last" required />
                    <label htmlFor="email-address">Email</label>
                    <input type="email" name="_replyto" id="email-address" placeholder="something@email.com" required />
